...
const Addproject = () => {
    ...
    <div className="mt-12 flex gap-x-4 justify-center">
                  <button className="inline-block rounded-lg bg-bleu px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-bleu hover:bg-indigo-500 hover:ring-indigo-500 cursor-not-allowed">
                  Add a project
                  </button>
        </div>
    )
